...
const ListPage= () => {
  ...
  const handleImg = (e) => {
    ...
    <div>Name
        ...
        onChange={(e) => setlocation(e.target.value)} type="text"></input>
        </div>
        <div>Price
        <input value={price}
        onChange={(e) => setprice(e.target.value)} type="number"></input>
        </div>
        <div>Carpet_area(in sq.ft)
        <input value={carpet}
        onChange={(e) => setcarpet(e.target.value)} type="number"></input>
        </div>
        <div>Number of Bedrooms
        <input value={bhk}
        onChange={(e) => setbhk(e.target.value)} type="number"></input>
        </div>
        <div>Furnished
        ...
        <div>Rent Price
        <input value={rent}
        onChange={(e) => setrent(e.target.value)} type="number"></input>
        </div>
        <div>Contact Number
        <input value={contact}
        onChange={(e) => setcontact(e.target.value)} type="number"></input>
        </div>
        <div>Description of Property
        <input value={description}
        onChange={(e) => setdescription(e.target.value)} type="text"></input>
        </div>
        <div className="mb-3">

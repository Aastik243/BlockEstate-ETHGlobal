...
import {
 ...
 // import { ApolloClient, InMemoryCache, gql } from "@apollo/client";
  ...
  const fetchPropertyById = async(proopertyIndex) =>{
    try {
        const contract = await connectingWithSmartContract();
...
const adjustRent = async (newRentAmount, propertyIndex) => {
    try {
        ...
        await contract.methods.adjustRent(newRentAmount, propertyIndex).send({ from: currentAccount });
...
const cancelAgreement = async (propertyIndex) => {
    try {
        ...
        await contract.methods.cancelAgreement(propertyIndex).send({ from: currentAccount });
...
const landlordCancelAgreement = async (propertyIndex) => {
    try {
        ...
        await contract.methods.landlordCancelAgreement(propertyIndex).send({ from: currentAccount });
